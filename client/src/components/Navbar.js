...
const Navbar = () => {
    ...
    return (
        <nav className={`fixed w-full top-0 z-[1000] transition-all duration-300 ${scrolled ? 'bg-dark-surface/80 backdrop-blur-xl border-b border-dark-border py-4' : 'bg-transparent py-6'}`}>
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex items-center justify-between">
                    
                    {/* Logo */}
                    <Link to="/" className="text-2xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">
                        FreelanceTracker
                    </Link>
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        {user ? (
                            ...
                            <div className="flex items-center space-x-4 border-l border-dark-border pl-6">
                                ...
                                <Link to="/register" className="text-sm font-semibold bg-gradient-to-r from-primary to-secondary text-white px-5 py-2.5 rounded-full hover:shadow-glow-primary transition-all duration-300 transform hover:-translate-y-0.5">
                                    Sign Up
                                </Link>
                            </div>
                        )}
